...
insert into polygon.performances(name, date, description, poster, restriction, trailerLink) values('Champions Cup Finals Counter Strike: Malta 2019', '2019-12-10', 'Эксклюзивные прямые трансляции Гранд-Финала Champions Cup Finals по игре Counter Strike на большом экране! Champions Cup Final - финала кубка чемпионов по игре Counter Strike, который пройдет с 19 по 22 декабря на Мальте.', FILE_READ('src/main/resources/images/19.jpg'), '12+', 'https://www.youtube.com/embed/axacWiQ9lYw');
